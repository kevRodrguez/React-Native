...
// esto deberia de ser delegado al backend para mayor seguridad, pero por simplicidad lo haremos aqui
...
async function registerForPushNotificationsAsync() {
    ...
    if (Device.isDevice) {
        ...
        if (existingStatus !== 'granted') {
            //importante, si no se pide permiso, no se puede obtener el token
